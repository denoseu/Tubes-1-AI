...
def genetic_algorithm(n, population_size, generations, mutation_rate):
    ...
    # population = [initial_cube.copy() for _ in range(population_size)]
    
    # jalankan evolusi selama beberapa generasi
    best_individual = None
    best_fitness = -1
    
    for generation in range(generations):
        # evaluasi populasi dan hitung fitness setiap individu
        ...
        for _ in range(population_size // 2):
            ...
            # crossover untuk membuat offspring
...
final_cube_genetic, final_fitness = genetic_algorithm(n, population_size=200, generations=1000, mutation_rate=0.3)
end_time = time.time()
